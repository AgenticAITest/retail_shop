...
const ProductImport = () => {
  ...
  async function handleExport() {
    try {
      const response = await axios.get("/api/modules/product-catalog/import-export/export", {
        responseType: "text",
      });
      const blob = new Blob([response.data], { type: "text/csv" });
      const url = window.URL.createObjectURL(blob);
    ...
    <>
      ...
      <header className="flex items-center justify-between gap-2 px-2 pb-4">
        <div className="flex items-center gap-2">
          <h1 className="text-2xl font-semibold">Import / Export Products</h1>
        </div>
      </header>
          ...
          {step === 1 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Download the CSV template file, fill in your product data, then upload it in the next step.
              ...
              <CardContent className="flex flex-col gap-4">
                ...
                <div className="flex justify-between flex-wrap gap-2">
                  <div className="flex gap-2">
                    ...
                    <Button variant="outline" onClick={() => navigate("/console/modules/product-catalog/product")}>
                      <ArrowLeft size={16} className="mr-2" />
                      Back to Products
                    </Button>
                  </div>
...
export default withModuleAuthorization(ProductImport, {
