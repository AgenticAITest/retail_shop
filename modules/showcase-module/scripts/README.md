# Showcase Module - Database Scripts

This directory contains SQL scripts for the **Showcase Module** module.
...
3. **Verify installation**:
   ...
   WHERE table_name = 'showcase-module' 
   AND table_schema = 'tenant_example';
   ```

## Module Information

- **Module ID**: showcase-module
- **Module Name**: Showcase Module
- **Version**: 1.0.0
- **Category**: Demo
...
WHERE tablename = 'showcase-module';
```
...
- Project repository: https://github.com/your-org/your-module.git
